...
The details of the installation and the basic knowledge of Conda is introduced in [Install Anaconda and Python](/doc/quick_start/install_anaconda_and_python.md).
